...
export default function RestablecerContra() {
    ...
    const handleVerificar = async (e) => {
        ...
        try {
            ...
            const respuesta = await fetch(`${API_BASE}/usuario/verificar-cor-o-tel`, {
                method: "POST",
    ...
    const handleObtenerPreguntaSeguridad = async (campo) => {
        try {
            ...
            const respuesta = await fetch(`${API_BASE}/usuario/pregunta-seguridad${params}`, {
                method: "GET",
                headers: { 'Content-Type': 'application/json' }
            });
    ...
    const handleVerificarRespuesta = async (e) => {
        ...
        try {
            ...
            const respuesta = await fetch(`${API_BASE}/usuario/verificar-respuesta`, {
                method: "POST",
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(body)
            });
    ...
    const handleRestablecerContrasena = async (e) => {
        ...
        try {
            ...
            const respuesta = await fetch(`${API_BASE}/usuario/restablecer-contrasena`, {
                method: "PATCH",
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(body)
            });
